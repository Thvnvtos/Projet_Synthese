...
for sc in sorted(scenarios):
	...
	os.system("Ocaml_func/check_confs.byte solved_scenarios/{} > temp.txt".format(sc))
	with open("temp.txt", 'r') as f:
		if f.readlines() == []:
			...
			if debug:
				...
				os.system("Ocaml_func/check_confs.byte solved_scenarios/{} >> logs/solve_confs_logs.txt".format(sc))
